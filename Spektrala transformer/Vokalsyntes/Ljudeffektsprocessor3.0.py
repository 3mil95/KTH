...
class Ljudeffektprocessor():
    ...
    def save(self):
        ...
        scipy.io.wavfile.write(filename, self.fs, self.X)
...
class GUI():
    def __init__(self, root):
        ...
        filemenu.add_command(label="Save", command=E.save)
    ...
    def whawhaGUI(self):
        ...
        self.whaSlider4 = Scale(self.wha_frame, length=200, from_=0, to=10000, showvalue=0.01, resolution=0.01)
